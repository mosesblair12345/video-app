...
const PrivacyPolicy = () => {
  return (
    <Wrapper>
      ...
      <p>
        Tube (“we,” “our,” or “us”) is committed to protecting your privacy.
        This Privacy Policy explains how your personal information is collected,
        used, and disclosed by Tube . <br />
        This Privacy Policy applies to our website, and its associated
        subdomains (collectively, our “Service”) alongside our application, Tube
        .<br />
        ...
        <li>
          ...
          Nairobi Kenya. that is responsible for your information under this
          Privacy Policy.
        </li>
        <li>
          <span>Country</span>: where Tube or the owners/founders of Tube are
          based, in this case is Kenya
        </li>
        <li>
          <span>Customer</span>: refers to the company, organization or person
          that signs up to use the Tube Service to manage the relationships with
          your consumers or service users.
        </li>
        <li>
          <span>Device</span>: any internet connected device such as a phone,
          tablet, computer or any other device that can be used to visit Tube
        ...
        <li>
          ...
          by Tube or are under contract to perform a service on behalf of one of
          the parties.
        </li>
        <li>
        ...
        <li>
          <span>Service</span>: refers to the service provided by Tube as
        ...
        <li>
          <span>Website</span>: Tube ‘s site, which can be accessed via this
          URL: tube.co.ke
        </li>
        <li>
          <span>You</span>: a person or entity that is registered with Tube to
          use the Services. What Information Do We Collect? We collect
          information from you when you visit our website, register on our site,
        ...
        <li>
          <span>Phonebook</span> (Contacts list): Your contacts list allows the
          website to be much more easy to use by the user, since accessing your
          contacts from the app makes you save tons of time. How Do We Use The
          Information We Collect? Any of the information we collect from you may
        ...
        <br />
        When does Tube use end user information from third parties?
        <br />
        <br />
        Tube will collect End User Data necessary to provide the Tube services
        ...
        <br />
        <br />
        When does Tube use customer information from third parties?
        <br />
        <br />
        ...
        in becoming a Tube customer, we receive information from a third party
        that provides automated fraud detection services to Tube . We also
        ...
        <br />
        <br />
        Tube will collect personal information that you submit to us. We may
        ...
        <br />
        <br />
        We keep your information only so long as we need it to provide Tube to
        ...
        any information you transmit to Tube or guarantee that your information
        ...
        <br />
        <br />
        Tube is incorporated in Kenya. Information collected via our website,
        ...
        <br />
        <br />
        Is the information collected through the Tube Service secure?
        <br />
        <br />
        ...
        Tube collects depend on your relationship with Tube . Personnel may
        ...
        Personnel
        <br />
        If you are a Tube worker or applicant, we collect information you
        ...
        the assets of Tube or any of its Corporate Affiliates (as defined
        herein), or that portion of Tube or any of its Corporate Affiliates to
        ...
        Tube , whether by ownership or otherwise. Any information relating to
        ...
        Governing Law
        <br />
        This Privacy Policy is governed by the laws of Kenya without regard to
        ...
        under Privacy Shield, or the Swiss-US framework. The laws of Kenya,
        ...
        other local, state, national, or international laws. By using Tube or
        ...
        engage with our website, or use our services. Continued use of the
        ...
        contain links to other websites not operated or controlled by Tube . We
        ...
        Cookies
        <br />
        Tube uses “Cookies” to identify the areas of our website that you have
        ...
        acknowledge and agree that Tube shall not be responsible for any
        ...
        or any other aspect thereof. Tube does not assume and shall not have any
        ...
        for security purposes. Google Maps API collects information that is held
        ...
        previously. Information about General Data Protection Regulation (GDPR)
        ...
        in the wrong way. What is GDPR? GDPR is an EU-wide privacy and data
        protection law that regulates how EU residents’ data is protected by
        companies and enhances the control the EU residents have, over their
        personal data. The GDPR is relevant to any globally operating company
        and not just the EU-based businesses and EU residents. Our customers’
        data is important irrespective of where they are located, which is why
        we have implemented GDPR controls as our baseline standard for all our
        ...
        At Tube we strongly believe that your data privacy is very important and
        we already have solid security and privacy practices in place that go
        beyond the requirements of this new regulation. Individual Data
        Subject’s Rights – Data Access,
        <br />
        Portability and Deletion
        <br />
        We are committed to helping our customers meet the data subject rights
        requirements of GDPR. Tube processes or stores all personal data in
        ...
        information about these rights, please contact us. California Online
        Privacy Protection Act (CalOPPA) CalOPPA requires us to disclose
        categories of Personal Information we collect and how we use it, the
        categories of sources from whom we collect Personal Information, and the
        ...
        <br />
        We do not sell the Personal Information of our users. For more
        information about these rights, please contact us. Contact Us Don’t
